...
bool SystemClass::Initialize()
{
    ...
    uuid = m_Graphics->LoadModelResource("../Engine/data/swordOpt.bin", L"../Engine/data/sword.tif");
    uuid = m_Graphics->LoadModelResource("../Engine/data/knightOpt.bin", L"../Engine/data/armor.jpg");
